...
const Header = ({onChange}:Prop) =>{
    ...
    return(
        <HeaderContainer>
            ...
            <PhoneWrapper >
            <a href='https://api.whatsapp.com/send?phone=557791455292'><MdWhatsapp className='whatsapp-icon-sidebar'/><p className='description-icon'>(77) 9145-5292</p></a>
            </PhoneWrapper>  
